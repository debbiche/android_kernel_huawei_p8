...
#define PWR_TCM_MODEM_RESUME_SIZE        0x20

#define PWR_TCM_MODEM_RESUME_OK_ADDR    (PWR_TCM_MODEM_RESUME_ADDR + PWR_TCM_MODEM_RESUME_SIZE)
#define PWR_TCM_MODEM_RESUME_OK_SIZE     0x20

#define PWR_TCM_MODEM_UP_ADDR           (PWR_TCM_MODEM_RESUME_OK_ADDR + PWR_TCM_MODEM_RESUME_OK_SIZE)
...
#define PWR_TCM_MODEM_DPM_ADDR          (PWR_TCM_MODEM_INIT_ADDR + PWR_TCM_MODEM_INIT_SIZE)
#define PWR_TCM_MODEM_DPM_SIZE          0x40
