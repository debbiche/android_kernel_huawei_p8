...
XML_RESULT_ENUM_UINT32 xml_write_nv_data(void)
{
    ...
    lisnv = strcmp((char *)xml_ctrl.g_stlxmlcurrentnode.pcnodelabel, (char *)g_aclnodelabelnv);

    liscust = strcmp((char *)xml_ctrl.g_stlxmlcurrentnode.pcnodelabel, (char *)g_aclnodelabelcust);
...
XML_RESULT_ENUM_UINT32 xml_checknodelabelvalid(void)
{
    ...
    /* 如果当前节点为无效状态,需要检查标签是否为有效节点 */
    if (0 == strcmp((char *)xml_ctrl.g_stlxmlcurrentnode.pcnodelabel,
                        (char *)g_aclnodelabelproductNvInfo))
    {
                             ...
                             (char *)g_aclnodelabelproduct))
    {
        ...
        if (0 == strcmp((char *)xml_ctrl.g_stlxmlcurrentnode.stproperty.pcpropertyvalue,
                            (char *)xml_ctrl.g_stlxmlproductinfo.acproductid))
        {
            xml_ctrl.g_stlxmlproductinfo.envalidnode= XML_PRODUCT_NODE_STATUS_VALID;
