...
/*****************************************************************************
  2 宏定义
*****************************************************************************/
#define PBXA9_UART_CLK          	(19200000)
#define UART5_HIGH_CLK				(96000000)
...
#define PERI_CRG_CLKDIV1_REG		0xac
#define SEL_UARTL_MASK				(1 << 2)
...
#define UART5_IRQ_LINE_ENABLE		1
#define UART5_IRQ_LINE_DISABLE		0
/*****************************************************************************
  3 枚举定义
*****************************************************************************/
...
struct dual_modem_control
{
	...
	u32 uart_irq_line_flag;
	u32 dual_modem_nv_flag;
};
