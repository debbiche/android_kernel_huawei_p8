...
/*****************************************************************************
 ...
 返 回 值  : 0 - 成功，非0 - 失败
*****************************************************************************/
PWC_COMM_STATUS_E bsp_pmu_get_pa_powerstatus(PWC_COMM_MODEM_E modem_id, PWC_COMM_MODE_E mode_id)
{
...
/*****************************************************************************
 ...
 返 回 值  : 0 - 成功，非0 - 失败
*****************************************************************************/
s32 bsp_pmu_pa_poweron(PWC_COMM_MODEM_E modem_id, PWC_COMM_MODE_E mode_id)
{
    s32 ret = OK;
...
/*****************************************************************************
 ...
 返 回 值  : 0 - 成功，非0 - 失败
*****************************************************************************/
s32 bsp_pmu_pa_poweroff(PWC_COMM_MODEM_E modem_id, PWC_COMM_MODE_E mode_id)
{
    s32 ret = OK;
...
/*****************************************************************************
 ...
 返 回 值  : pa电源开关状态
*****************************************************************************/
int dummy_pmu_pa_poweron(PWC_COMM_MODEM_E modem_id, PWC_COMM_MODE_E mode_id)
{
	parf_print_error("ERROR: pa_rf didn't build all function!\n");
	return OK;
}
...
/*****************************************************************************
 ...
 返 回 值  : pa 电源开关状态
*****************************************************************************/
int dummy_pmu_pa_poweroff(PWC_COMM_MODEM_E modem_id, PWC_COMM_MODE_E mode_id)
{
	parf_print_error("ERROR: pa_rf didn't build all function!\n");
	return OK;
}
...
/*****************************************************************************
 ...
 返 回 值  : pa电源开关状态
*****************************************************************************/
PWC_COMM_STATUS_E dummy_pmu_get_pa_powerstatus(PWC_COMM_MODEM_E modem_id, PWC_COMM_MODE_E mode_id)
{
	parf_print_error("ERROR: pa_rf didn't build all function!\n");
	return PWC_COMM_MODE_BUTT;
}
...
/*****************************************************************************
 ...
 返 回 值  : 0 - 成功，非0 - 失败
*****************************************************************************/
s32 bsp_pa_poweron(PWC_COMM_MODEM_E modem_id, PWC_COMM_MODE_E mode_id)
{
    return  pmu_parf_ops.pmu_pa_power_on(modem_id,mode_id); 
}
...
/*****************************************************************************
 ...
 返 回 值  : 0 - 成功，非0 - 失败
*****************************************************************************/
s32 bsp_pa_poweroff(PWC_COMM_MODEM_E modem_id,PWC_COMM_MODE_E mode_id)
{
    return  pmu_parf_ops.pmu_pa_power_off(modem_id, mode_id); 
}
...
/*****************************************************************************
 ...
 返 回 值  : 0 - 成功，非0 - 失败
*****************************************************************************/
PWC_COMM_STATUS_E bsp_get_pa_powerstatus(PWC_COMM_MODEM_E modem_id,PWC_COMM_MODE_E mode_id)
{
    return  pmu_parf_ops.pmu_pa_power_status(modem_id,mode_id); 
}
