...
VOS_VOID  NAS_ESM_PdnConRejRecord(const EMM_ESM_INTRA_DATA_IND_STRU *pstEmmEsmDataInd)
{
    ESM_ERR_INFO_PDN_CONN_REJ_RESULT_EVENT_STRU             stEsmPdnConnRejRslt;
    VOS_UINT32                                              ulLength;
    VOS_UINT16                                              usLevel;
    VOS_UINT32                                              ulIsLogRecord;

    NAS_ESM_NORM_LOG("NAS_ESM_PdnConRejRecord!!");
    ...
    PS_MEM_SET(&stEsmPdnConnRejRslt, 0x00, ulLength);

    /*填充esm fail异常场景头*/
    NAS_ESM_COMM_BULID_ERRLOG_HEADER_INFO(&stEsmPdnConnRejRslt.stHeader,
    ...
    stEsmPdnConnRejRslt.enFailCause =
                    NAS_ESM_CnCauseProc(pstEmmEsmDataInd->stEsmNwMsgIE.enEsmCau);

    /*发送ESM errlog信息给EMM，为防止并发导致存储log失败，由EMM保存*/
    NAS_ESM_SndEsmErrlogToEmm(&stEsmPdnConnRejRslt, ulLength);
}


VOS_VOID  NAS_ESM_PdnDisconRejRecord(const EMM_ESM_INTRA_DATA_IND_STRU *pstEmmEsmDataInd)
{
    ESM_ERR_INFO_PDN_DISCONN_REJ_RESULT_EVENT_STRU          stEsmPdnDisconRejRslt;
    VOS_UINT32                                              ulLength;
    VOS_UINT16                                              usLevel;
    VOS_UINT32                                              ulIsLogRecord;


    NAS_ESM_NORM_LOG("NAS_ESM_PdnDisconRejRecord!!");
    ...
    PS_MEM_SET(&stEsmPdnDisconRejRslt, 0x00, ulLength);

    /*填充esm fail异常场景头*/
    NAS_ESM_COMM_BULID_ERRLOG_HEADER_INFO(&stEsmPdnDisconRejRslt.stHeader,
                                   VOS_GetModemIDFromPid(PS_PID_ESM),
    ...
    stEsmPdnDisconRejRslt.enFailCause =
                    NAS_ESM_CnCauseProc(pstEmmEsmDataInd->stEsmNwMsgIE.enEsmCau);

    /*发送ESM errlog信息给EMM，为防止并发导致存储log失败，由EMM保存*/
     NAS_ESM_SndEsmErrlogToEmm(&stEsmPdnDisconRejRslt, ulLength);
}


VOS_VOID  NAS_ESM_ResModRejRecord(const EMM_ESM_INTRA_DATA_IND_STRU *pstEmmEsmDataInd)
{
    ESM_ERR_INFO_RES_MOD_REJ_RESULT_EVENT_STRU              stEsmResModRejRslt;
    VOS_UINT32                                              ulLength;
    VOS_UINT16                                              usLevel;
    VOS_UINT32                                              ulIsLogRecord;

    NAS_ESM_NORM_LOG("NAS_ESM_ResModRejRecord!!");
    ...
    PS_MEM_SET(&stEsmResModRejRslt, 0x00, ulLength);

    /*填充esm fail异常场景头*/
    NAS_ESM_COMM_BULID_ERRLOG_HEADER_INFO(&stEsmResModRejRslt.stHeader,
                                   VOS_GetModemIDFromPid(PS_PID_ESM),
    ...
    stEsmResModRejRslt.enFailCause =
                    NAS_ESM_CnCauseProc(pstEmmEsmDataInd->stEsmNwMsgIE.enEsmCau);

    /*发送ESM errlog信息给EMM，为防止并发导致存储log失败，由EMM保存*/
    NAS_ESM_SndEsmErrlogToEmm(&stEsmResModRejRslt, ulLength);
}


VOS_VOID  NAS_ESM_ResAllocRejRecord(const EMM_ESM_INTRA_DATA_IND_STRU *pstEmmEsmDataInd)
{
    ESM_ERR_INFO_RES_ALLOC_REJ_RESULT_EVENT_STRU            stEsmResAllocRejRslt;
    VOS_UINT32                                              ulLength;
    VOS_UINT16                                              usLevel;
    VOS_UINT32                                              ulIsLogRecord;

    NAS_ESM_NORM_LOG("NAS_ESM_ResAllocRejRecord!!");
    ...
    PS_MEM_SET(&stEsmResAllocRejRslt, 0x00, ulLength);

    /*填充esm fail异常场景头*/
    NAS_ESM_COMM_BULID_ERRLOG_HEADER_INFO(&stEsmResAllocRejRslt.stHeader,
                                   VOS_GetModemIDFromPid(PS_PID_ESM),
    ...
    stEsmResAllocRejRslt.enFailCause =
                    NAS_ESM_CnCauseProc(pstEmmEsmDataInd->stEsmNwMsgIE.enEsmCau);

    /*发送ESM errlog信息给EMM，为防止并发导致存储log失败，由EMM保存*/
    NAS_ESM_SndEsmErrlogToEmm(&stEsmResAllocRejRslt, ulLength);
}
#endif
#ifdef __cplusplus
    #if __cplusplus
