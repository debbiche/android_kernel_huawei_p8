         ...
         EMM_OM_ERRLOG_TYPE_ENUM_UINT16    enErrType)
{
    ...
    NAS_EMM_CN_ATTACH_REJ_STRU                              *pstCnAttachRej;
         ...
         EMM_OM_ERRLOG_TYPE_ENUM_UINT16    enErrType)
{
    ...
    NAS_EMM_CN_TAU_REJ_STRU                                 *pstCnTAURej;
    VOS_UINT32                                              ulIsLogRecord;
    VOS_UINT32                                              ulLength;
    VOS_UINT32                                              ulResult;
    VOS_UINT16                                              usLevel;
...

{
    ...
    stNorServerRslt.enErrType = EMM_OM_ERRLOG_TYPE_CN_REJ;
...
VOS_VOID NAS_LMM_SndDebugInfoInd(VOS_UINT32 ulFileName, VOS_UINT32 ulLineNo, VOS_UINT16 ucPara1, VOS_UINT16 ucPara2, VOS_UINT16 ucPara3, VOS_UINT16 ucPara4)
{
    ...
    stMsg.ulMsgId             = PS_MSG_ID_EMM_TO_EMM_OM_BASE + 0x5F;
