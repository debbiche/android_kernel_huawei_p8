...
/*****************************************************************************
 联合名    : OAM_UPHY_SAR_REDUCTION_UNION
 联合说明  : PHY_OAM_SAR_CTRL_REQ_STRU结构体中的ulSarReduction，使用此定义。
*****************************************************************************/
typedef union
{
    VOS_UINT32                              ulValue;
    ...
    struct
    {
        VOS_UINT32                          ulLteSpecialScene   : 8;            /* bit0:7，Lte特殊场景，最大支持８个特殊场景，BIT0代表第一个特殊场景，依此类推 */
        VOS_UINT32                          ulWcdmaSpecialScene : 4;            /* bit8:11，Wcdma特殊场景，最大支持4个特殊场景，BIT8代表第一个特殊场景，依此类推 */
        VOS_UINT32                          ulReductionLevel    : 3;            /* bit11:14，Sar等级(0-5) */
        VOS_UINT32                          ulReserved          : 17;           /* bit15:31，保留 */
    }stSar;
}OAM_UPHY_SAR_REDUCTION_UNION;
